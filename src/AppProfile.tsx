            ...
            <div className="space-y-4">
              <div className="bg-white/5 rounded-2xl p-4 border border-white/10">
                ...
                <div className="text-base font-medium mt-1">
                  ...
                  <p />
                  ⛹️‍♂️ Если у кого-то есть принадлежности для активного отдыха (бадминтон, футбольный мяч и т. д.), прошу отписаться в личные сообщения.
                  <p />
                  ...
                  <p className="p-2" />
                  Точный ответ придёте или нет прошу дать до 17 июня.
                  Надеюсь, что все смогут.
                  <p className="p-2" />
                  Целую, Ксю! 💋
                </div>
              </div>
